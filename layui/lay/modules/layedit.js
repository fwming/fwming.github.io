...
function js_beautify(t, e, i, n) {
	...
	function p() {
		...
		if(f(e, k)) {
			if(A < m.length)
				for(; f(m.charAt(A), k) && (e += m.charAt(A), (A += 1) !== m.length););
...
layui.define(["layer", "form", "code"], function(t) {
	...
	s.prototype.set = function(t) {
		...
		var n = this,
			...
			m = i(['<div class="' + o + '">', '<div class="layui-unselect layui-layedit-tool">' + p.replace("layBkColor_Index", "layBkColor_" + n.index).replace("layFontColor_Index", "layFontColor_" + n.index) + "</div>", '<div class="layui-layedit-iframe">', '<iframe  src="" id="' + c + '" name="' + c + '" textarea="' + t + '" frameborder="0"></iframe>', "</div>", "</div>"].join(""));
	...
	var r = function(t, e, n) {
			...
			a.css({
				...
				var o = a.contents(),
					...
					d = i(["<style>", "*{margin: 0; padding: 0;}", "body{padding: 10px; line-height: 20px; overflow-x: hidden; word-wrap: break-word; font: 14px Helvetica Neue,Helvetica,PingFang SC,Microsoft YaHei,Tahoma,Arial,sans-serif; -webkit-box-sizing: border-box !important; -moz-box-sizing: border-box !important; box-sizing: border-box !important; overflow-y: auto;scrollbar-3dlight-color: #f0f0ee;scrollbar-arrow-color: #676662;scrollbar-base-color: #f0f0ee;scrollbar-darkshadow-color: #ddd;scrollbar-face-color: #e0e0dd;scrollbar-highlight-color: #f0f0ee;scrollbar-shadow-color: #f0f0ee;scrollbar-track-color: #f5f5f5}", "video{max-width:400px;}", "table{border-collapse: collapse;}", "img{display: inline-block; border: none; vertical-align: middle;}", "pre{margin: 10px 0; padding: 10px; line-height: 20px; border: 1px solid #ddd; border-left-width: 6px; background-color: #F2F2F2; color: #333; font-family: Courier New; font-size: 12px;}", "</style>"].join("")),
					c = o.find("body"),
					f = function() {
						var t = [];
			...
			return t.hide = t.hide || function(e) {
				...
				success: function(t, l) {
					t.find("td").on("touchmove", function(n) {
						...
						if(null != l && "TD" === l.tagName.toUpperCase()) {
							...
							for(var a = 0; a < i(l.parentElement).prevAll().length; a++)
								for(var o = 0; o < i(l.parentElement).prevAll()[a].childNodes.length; o++) o <= l.cellIndex && (i(l.parentElement).prevAll()[a].children[o].style = "background-color:linen;")
						}
				...
				success: function(e, l) {
					e.find("td").on("mouseover", function() {
						...
						for(var t = 0; t < i(this.parentElement).prevAll().length; t++)
							for(var n = 0; n < i(this.parentElement).prevAll()[t].childNodes.length; n++) n <= this.cellIndex && (i(this.parentElement).prevAll()[t].children[n].style = "background-color:linen;")
